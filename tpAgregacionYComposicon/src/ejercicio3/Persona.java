...
public class Persona {
	...
	//Composición xq rara vez cambian de dueño las mascotas y ademas en caso de desaparecer la persona no me interesa quedarme con esos datos
	public void agregarMascota(String tipo, String nombre) {
		Mascota mas = new Mascota(nombre, tipo);
		lMascotas.add(mas);
	}
	
	//Agregación xq el hito existe en si mismo y puede ser compartido por varios 
